...
func (o *Options) AddFlags(fs *flag.FlagSet) {
	...
	fs.StringVar(&o.fieldsetVersion, "fieldset-version", "v1", "Version of fieldset encoding to use. Should be either 'v1' (default) or 'v2'.")
...
func (o *Options) Resolve() (Operation, error) {
	...
	case o.fieldset != "":
		return fieldset{base, o.fieldset, o.fieldsetVersion}, nil
	}
